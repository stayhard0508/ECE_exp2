...
module text_LCD_basic(rst, clk, LCD_E, LCD_RS, LCD_RW, LCD_DATA, led_red,led_yellow,led_green,led_left,led_walk_red,led_walk_green);
...
TrafficLight TL(clk,rst,led_red,led_yellow,led_green,led_left,led_walk_red,led_walk_green,count,hours,minutes,seconds,state_TL);
