...
module text_LCD_basic(rst, clk, btn_speed, btn_1h, LCD_E, LCD_RS, LCD_RW, LCD_DATA, led_red,led_yellow,led_green,led_left,led_walk_red,led_walk_green);
...
clock ck1(clk,rst, btn_speed,btn_1h, hours,minutes,seconds);
...
TrafficLight TL(clk,rst,hours,minutes,seconds, btn_speed,btn_1h, led_red,led_yellow,led_green,led_left,led_walk_red,led_walk_green,count,state_TL);
            ...
            LINE2 :
                begin 
                    case(cnt)
                        ...
                        06 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0101; //:
