...
module text_LCD_basic(rst, clk, LCD_E, LCD_RS, LCD_RW, LCD_DATA);
            ...
            LINE2 :
                begin 
                    case(cnt)
                        ...
                        01 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0010; //s
                        02 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0000; //t
                        03 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0001; //a
                        04 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0110; //t
                        05 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0100; //e
                        06 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0100; //:
                        07 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0000; //A
                        08 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0000; //(
                        09 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_1001; //n
                        10 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0111; //i
                        11 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0010_0000; //g
                        12 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0100_1100; //h
                        13 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0100_1001; //t
                        14 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0100_1010; //)
                        15 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0010_0000; //
                        16 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0010_0000; //
                        default : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0010_0000; //
                    endcase
