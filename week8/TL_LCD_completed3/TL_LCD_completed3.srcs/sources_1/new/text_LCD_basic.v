            ...
            LINE1 :
                begin 
                    case(cnt)
                        ...
                        06 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0000 + hours_bcd[7:4]; //십의 자리 hour
                        07 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0000 + hours_bcd[3:0]; //일의 자리 hour
                        08 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_1010; //:
                        09 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0000 + minutes_bcd[7:4]; //십의 자리
                        10 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0000 + minutes_bcd[3:0]; //일의 자리
                        11 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_1010; //:
                        12 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0000 + seconds_bcd[7:4]; //십의 자리
                        13 : {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_0_0011_0000 + seconds_bcd[3:0]; //일의 자리
